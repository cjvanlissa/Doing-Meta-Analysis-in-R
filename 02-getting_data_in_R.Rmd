...
One way to get Excel files directly into R is by using the XLConnect package. For this example, you will need the *"happy.xlsx"* file. Check if the file is in your project directory. If not, you can download it from https://github.com/cjvanlissa/Doing-Meta-Analysis-in-R/happy.xlsx.
...
SPSS files can be loaded using the `foreign` package. For this example, you can download an SPSS file at
https://github.com/cjvanlissa/Doing-Meta-Analysis-in-R/problem2.sav.
