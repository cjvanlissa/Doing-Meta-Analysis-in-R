...
One way to get Excel files directly into R is by using the XLConnect package. For this example, you will need the *"happy.xlsx"* file. Check if the file is in your project directory. If not, you can download it from https://github.com/cjvanlissa/Doing-Meta-Analysis-in-R.
...
SPSS files can be loaded using the `foreign` package:
...
# Read the SPSS data
df_spss <- read.spss("problem3.sav",
                     to.data.frame = TRUE,
