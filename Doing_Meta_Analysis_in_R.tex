...
\hypersetup{unicode=true,
            pdftitle={Doing Meta-Analysis in R and exploring heterogeneity using metaforest},
            pdfauthor={Caspar van Lissa¹},
            pdfborder={0 0 0},
            breaklinks=true}
...
\href{https://zenodo.org/badge/latestdoi/152492192}{\includegraphics{https://zenodo.org/badge/152492192.svg}}
...
Although this output looks kind of messy, it's already very informative. It shows the structure of my data. In this case, i used data for which the effect sizes were already calculated. This is why the variables \textbf{TE} and \textbf{seTE} appear. I also see plenty of other variables, which correspond to the subgroups which were coded for this dataset.
...
Note that the \texttt{\%in\%}-Command tells the \texttt{filter} function to search for exactly the three cases we defined in the variable \texttt{Author}.
Now, let's have a look at the new data \texttt{madata.new} we just created.
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-72-1.pdf}
...
Looks good so far! For special \textbf{layout types}, proceed to \protect\hyperlink{layouttypes}{Chapter 5.2} now.

\begin{center}\rule{0.5\linewidth}{\linethickness}\end{center}

\hypertarget{layouttypes}{%
\section{Layout types}\label{layouttypes}}

The \texttt{meta::forest} function also has two \textbf{Layouts} preinstalled which we can use. Those layouts can be accessed with the \texttt{layout=} parameter.
...
\begin{center}\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-81-1} \end{center}
...
\begin{center}\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-82-1} \end{center}
...
Let's say i want to save the JAMA version of my Forest Plot now. To do this, i have to reuse the code with which i plotted my forest plot, and put it between \texttt{pdf(file=\textquotesingle{}name\_of\_the\_pdf\_i\_want\_to\_create.pdf\textquotesingle{})} and \texttt{dev.off}, both in separate lines. This saves the plot into a PDF in my Working Directory.

This way, i can export the plot in different formats (you can find more details on the saving options \protect\hyperlink{saving}{here}).
...
We have created the \textbf{function} \texttt{influence.analysis} for you through which influences can be conducted all in one. For this function to work, you need to have the \texttt{meta} and \texttt{metafor} packages installed and loaded in your library.
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-108-1} 
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-109-1} 
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-109-2} 
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{subgroup.analysis.mixed.effects}\NormalTok{(}\DataTypeTok{m=}\NormalTok{m.hksj,}
                                \DataTypeTok{subgroups=}\NormalTok{madata}\OperatorTok{$}\NormalTok{Control)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-125-1} 
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-130-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mvreg.data}\OperatorTok{$}\NormalTok{continent =}\StringTok{ }\KeywordTok{factor}\NormalTok{(mvreg.data}\OperatorTok{$}\NormalTok{continent)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-142-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-162-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-163-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-165-1.pdf}
...
We have prepared a function called \texttt{eggers.test} for you, which can be found below. The function is a wrapper for the \texttt{metabias} function in \texttt{meta}.
...
\NormalTok{  lower.intercept<-}\KeywordTok{as.numeric}\NormalTok{(intercept}\FloatTok{-1.96}\OperatorTok{*}\NormalTok{se.intercept)}
\NormalTok{  lower.intercept<-}\KeywordTok{round}\NormalTok{(lower.intercept,}\DataTypeTok{digits =} \DecValTok{2}\NormalTok{)}
\NormalTok{  higher.intercept<-}\KeywordTok{as.numeric}\NormalTok{(intercept}\FloatTok{+1.96}\OperatorTok{*}\NormalTok{se.intercept)}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-171-1.pdf}
...
\NormalTok{tot<-}\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"r("}\NormalTok{,output}\OperatorTok{$}\NormalTok{N.total}\DecValTok{-2}\NormalTok{,}\StringTok{")="}\NormalTok{,output}\OperatorTok{$}\NormalTok{r))}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-181-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-182-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-185-1.pdf}
...
To use the \texttt{rob.summary}, we have to specify our RoB data set in the function. In my case, this is \texttt{rob}. I will call my output \texttt{plot}.
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-191-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-195-1.pdf}
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-200-1} 
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-201-1} 
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-208-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-208-2.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-209-1.pdf}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-209-2.pdf}

\hypertarget{multilevel-meta-analysis}{%
\chapter{``Multilevel'' Meta-Analysis}\label{multilevel-meta-analysis}}

\includegraphics{multilevel.jpg}
...
\includegraphics{multilevel-model2.png}
...
R doesn't know this function yet, so we have to let R learn it copying and pasting the code underneath \textbf{in its entirety} into the \textbf{console} on the bottom left pane of RStudio, and then hit \textbf{Enter ⏎}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{variance.distribution}\FloatTok{.3}\NormalTok{lm <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data, m)\{}
  
  \CommentTok{# Calculate estimated sampling variance and proportions across levels  }
\NormalTok{  data <-}\StringTok{ }\NormalTok{data}
\NormalTok{    m <-}\StringTok{ }\NormalTok{m}
\NormalTok{    n <-}\StringTok{ }\KeywordTok{length}\NormalTok{(data}\OperatorTok{$}\NormalTok{v)}
\NormalTok{    vector.inv.var <-}\StringTok{ }\DecValTok{1}\OperatorTok{/}\NormalTok{(data}\OperatorTok{$}\NormalTok{v)}
\NormalTok{    sum.inv.var <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(vector.inv.var)}
\NormalTok{    sum.sq.inv.var <-}\StringTok{ }\NormalTok{(sum.inv.var)}\OperatorTok{^}\DecValTok{2}
\NormalTok{    vector.inv.var.sq <-}\StringTok{ }\DecValTok{1}\OperatorTok{/}\NormalTok{(data}\OperatorTok{$}\NormalTok{v}\OperatorTok{^}\DecValTok{2}\NormalTok{)}
\NormalTok{    sum.inv.var.sq <-}\StringTok{ }\KeywordTok{sum}\NormalTok{(vector.inv.var.sq)}
\NormalTok{    num <-}\StringTok{ }\NormalTok{(n}\DecValTok{-1}\NormalTok{)}\OperatorTok{*}\NormalTok{sum.inv.var}
\NormalTok{    den <-}\StringTok{ }\NormalTok{sum.sq.inv.var }\OperatorTok{-}\StringTok{ }\NormalTok{sum.inv.var.sq}
\NormalTok{    est.samp.var <-}\StringTok{ }\NormalTok{num}\OperatorTok{/}\NormalTok{den}
\NormalTok{    level1<-((est.samp.var)}\OperatorTok{/}\NormalTok{(m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{2}\NormalTok{]}\OperatorTok{+}\NormalTok{est.samp.var)}\OperatorTok{*}\DecValTok{100}\NormalTok{)}
\NormalTok{    level2<-((m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{1}\NormalTok{])}\OperatorTok{/}\NormalTok{(m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{2}\NormalTok{]}\OperatorTok{+}\NormalTok{est.samp.var)}\OperatorTok{*}\DecValTok{100}\NormalTok{)}
\NormalTok{    level3<-((m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{2}\NormalTok{])}\OperatorTok{/}\NormalTok{(m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{m}\OperatorTok{$}\NormalTok{sigma2[}\DecValTok{2}\NormalTok{]}\OperatorTok{+}\NormalTok{est.samp.var)}\OperatorTok{*}\DecValTok{100}\NormalTok{)}
\NormalTok{    Level<-}\KeywordTok{c}\NormalTok{(}\StringTok{"level 1"}\NormalTok{, }\StringTok{"level 2"}\NormalTok{, }\StringTok{"level 3"}\NormalTok{)}
\NormalTok{    Variance<-}\KeywordTok{c}\NormalTok{(level1, level2, level3)}
\NormalTok{    df<-}\KeywordTok{data.frame}\NormalTok{(Level, Variance)}
\NormalTok{    df1<-df}
    \KeywordTok{colnames}\NormalTok{(df1) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Level"}\NormalTok{, }\StringTok{"% of total variance"}\NormalTok{)}
    
    \CommentTok{# Generate plot}
\NormalTok{  df}\OperatorTok{$}\NormalTok{distribution<-}\StringTok{"Distribution"}
\NormalTok{  df}\OperatorTok{$}\NormalTok{Level<-}\KeywordTok{factor}\NormalTok{(df}\OperatorTok{$}\NormalTok{Level, }\KeywordTok{levels}\NormalTok{(df}\OperatorTok{$}\NormalTok{Level)[}\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{)])}
\NormalTok{  g <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{fill=}\NormalTok{Level, }\DataTypeTok{y=}\NormalTok{Variance, }\DataTypeTok{x=}\NormalTok{distribution)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{, }\DataTypeTok{position=}\StringTok{"fill"}\NormalTok{, }\DataTypeTok{width =} \FloatTok{0.3}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{coord_flip}\NormalTok{(}\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{labels =}\NormalTok{ scales}\OperatorTok{::}\NormalTok{percent)}\OperatorTok{+}
\StringTok{      }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.title.x=}\KeywordTok{element_blank}\NormalTok{(),}
        \DataTypeTok{axis.title.y=}\KeywordTok{element_blank}\NormalTok{(),}
        \DataTypeTok{axis.ticks.y=}\KeywordTok{element_blank}\NormalTok{(),}
        ...
        \DataTypeTok{legend.background =} \KeywordTok{element_rect}\NormalTok{(}\DataTypeTok{linetype=}\StringTok{"solid"}\NormalTok{,}
                                         \DataTypeTok{colour =}\StringTok{"black"}\NormalTok{),}
        \DataTypeTok{legend.title =} \KeywordTok{element_blank}\NormalTok{(),}
        \DataTypeTok{legend.key.size =} \KeywordTok{unit}\NormalTok{(}\FloatTok{0.75}\NormalTok{,}\StringTok{"cm"}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{guides}\NormalTok{(}\DataTypeTok{fill =} \KeywordTok{guide_legend}\NormalTok{(}\DataTypeTok{reverse =} \OtherTok{TRUE}\NormalTok{))}
  \KeywordTok{return}\NormalTok{(}\KeywordTok{list}\NormalTok{(g, df1))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-219-1.pdf}
...
\begin{center}\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-247-1} \end{center}
...
{\centering \includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/unnamed-chunk-251-1} 
...
\includegraphics{Doing_Meta_Analysis_in_R_files/figure-latex/pressure-1.pdf}
